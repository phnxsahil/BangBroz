      ...
      <div className="relative px-5 md:px-10 py-28 md:py-44 mx-auto max-w-[1400px] text-white">
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="label-mono" style={{ color: "rgba(255,255,255,0.7)" }}>
              07 — Your turn
            </span>
          </div>
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-3">
            ...
            <a href="#munsiyari" className="btn-ghost" style={{ background: "rgba(255,255,255,0.08)", color: "#fff", borderColor: "rgba(255,255,255,0.35)" }}>
              See next expedition
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-10 inline-flex items-center gap-2 label-mono text-white/70 hover:text-white transition-colors"
          >
