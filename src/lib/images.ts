...
export const IMG = {
  ...
  himalaya:        U("1506905925346-21bda4d32df4"),       // himalaya
  fogForest:       U("1448375240586-882707db888b"),       // fog forest
  village:         U("1519681393784-d120267933ba"),       // village in mountains
  trekker:         U("1551632811-561732d1e306"),          // trekker on ridge
  tent:            U("1504280390367-361c6d9f38f4"),       // camping
  prayerFlags:     U("1597983073512-bb1cb6f8c20a"),       // prayer flags
  chai:            U("1571934811356-5cc061b6821f"),       // chai cup

  // Destinations
  munsiyari:       U("1626621341517-bbf3d9990a23"),
  spiti:           U("1571536802807-30451e3955d8"),
  ladakh:          U("1589308078059-be1415eab4c3"),
  bir:             U("1599661046827-dacde6976549"),

  // Team / lifestyle
  group:           U("1530541930197-ff16ac917b0e"),       // group of trekkers
  road:            U("1502920917128-1aa500764cbd"),       // mountain road
  sunset:          U("1500530855697-b586d89ba3ee"),       // alpine sunset
